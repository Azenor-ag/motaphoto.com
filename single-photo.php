			...
			<div>
				...
				<p class="carrousel">
					...
					<a href="<?php echo $prevLink; ?>">
						<img class="arrow_left"src="<?php echo get_template_directory_uri(); ?>./assets/Line6.jpg" alt="fleche_gauche">
					</a>
					<?php $prevNext = get_next_post();
					$prevLinkNext = get_permalink($prevNext);?>
					<a href="<?php echo $prevLinkNext; ?>">
						<img class="arrow_right" src="<?php echo get_template_directory_uri(); ?>./assets/Line7.jpg" alt="fleche_droite">
					</a>
				</p>
			</div>
	  </div>
